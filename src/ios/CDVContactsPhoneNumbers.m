        ...
        [abHelper createAddressBook: ^(ABAddressBookRef addrBook) {
            ...
            for(int i = 0; i < phoneContacts.count; i++) {
                ...
                if (countPhones > 0) {
                    ...
                    NSString *firstNamePhonetic = (__bridge_transfer NSString*)ABRecordCopyValue(ref, kABPersonFirstNamePhoneticProperty);
                    if (!firstNamePhonetic)
                        firstNamePhonetic = @"";

                        NSString *lastNamePhonetic = (__bridge_transfer NSString*)ABRecordCopyValue(ref, kABPersonLastNamePhoneticProperty);
                    if (!lastNamePhonetic)
                        lastNamePhonetic = @"";
                    ...
                    [contactDictionary setObject: firstNamePhonetic forKey:@"firstNamePhonetic"];
                    [contactDictionary setObject: lastNamePhonetic forKey:@"lastNamePhonetic"];
