            ...
            if (c.getCount() > 0) {
                while (c.moveToNext()) {
                    ...
                    if (mimetype.equals(ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE)) {
                        ...
                        contact.put("firstNamePhonetic", c.getString(c.getColumnIndex(ContactsContract.CommonDataKinds.StructuredName.PHONETIC_GIVEN_NAME)));
                        contact.put("lastNamePhonetic", c.getString(c.getColumnIndex(ContactsContract.CommonDataKinds.StructuredName.PHONETIC_FAMILY_NAME)));
